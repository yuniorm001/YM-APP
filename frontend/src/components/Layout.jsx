            ...
            {isFabOpen && (
              ...
              >
                ...
                <motion.button
                  ...
                  className="pointer-events-auto group relative w-full max-w-[340px] flex items-center gap-3.5 rounded-[22px] border border-[#E7CACA] bg-[linear-gradient(135deg,rgba(255,255,255,0.98),rgba(255,241,241,0.98))] px-5 py-3.5 text-[#8E2F2F] overflow-hidden shadow-[0_18px_38px_rgba(142,47,47,0.20),0_0_0_1px_rgba(216,125,125,0.18),inset_0_1px_0_rgba(255,255,255,0.82)] ring-1 ring-white/35 transition-all duration-300 hover:border-[#D65F5F] hover:bg-[linear-gradient(135deg,rgba(255,255,255,1),rgba(255,234,234,1))] hover:shadow-[0_22px_50px_rgba(142,47,47,0.34),0_0_0_2px_rgba(214,95,95,0.30),0_0_22px_rgba(214,95,95,0.24),inset_0_1px_0_rgba(255,255,255,0.90)] focus-visible:border-[#D65F5F] focus-visible:shadow-[0_22px_50px_rgba(142,47,47,0.34),0_0_0_2px_rgba(214,95,95,0.34),0_0_22px_rgba(214,95,95,0.24),inset_0_1px_0_rgba(255,255,255,0.90)] active:border-[#D65F5F] active:shadow-[0_18px_42px_rgba(142,47,47,0.30),0_0_0_2px_rgba(214,95,95,0.28),inset_0_1px_0_rgba(255,255,255,0.88)]"
